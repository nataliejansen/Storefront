...
namespace FurnitureSteals.UI.MVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,CollectionName,ProductDescription,ManufacturerId,ProductStatus,CategoryId,Price,Quantity")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,CollectionName,ProductDescription,ManufacturerId,ProductStatus,CategoryId,Price,Quantity")] Product product)
        {
